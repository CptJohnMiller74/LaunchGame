...
public class gameController : MonoBehaviour {
    ...
    private bool isFlyingEnemyOnScreen;
    ...
    private float flyingEnemyFrequency = .5f;//.07f;
    ...
    public void spawn()
    {
        ...
        else if (randType >= bombEnemyFrequency + truckFrequency && randType < bombEnemyFrequency + truckFrequency + flyingEnemyFrequency && !isFlyingEnemyOnScreen)
        {
            enemy = Instantiate(flyingEnemy, new Vector3(randPosition, 4.5f, 0), Quaternion.identity);
            enemy.GetComponent<enemyController>().setVelocity(-randVelocity);
            GameObject enemy1 = Instantiate(flyingEnemy, new Vector3(randPosition + 10, 8.5f, 0), Quaternion.identity);
            enemy1.GetComponent<enemyController>().setVelocity(-randVelocity);
            isFlyingEnemyOnScreen = true;
            activeEnemies.Add(enemy);
    ...
    public void calculateDistance()
    {
        ...
        {
            upgradeManager.highScore = distance; //save locally
    ...
    */
    public void setIsFlyingEnemyOnScreen(bool b)
    {
        isFlyingEnemyOnScreen = b;
    }
